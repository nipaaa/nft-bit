...
import title1 from '../assets/logo/title_shapes.svg';
import title2 from '../assets/logo/title_shapes2.svg';

const Faq = () => {
    return (
        <div class="FAQ__section" id="FAQ">
        <div class="container">
            <div class="FAQ__inner">
                <div class="FAQ__title">
                    <h4> <img src={title1} alt="image"/> QUESTIONS & ANSWERS <img src={title2} alt=""/> </h4>
